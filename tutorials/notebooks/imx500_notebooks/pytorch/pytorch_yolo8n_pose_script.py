...
#
PRETRAINED_WEIGHTS_FILE = ('/data/projects/swat/users/idanb/repository/git4/model_optimization/tutorials/notebooks'
                           '/imx500_notebooks/pytorch/yolov8n-pose.pt')
...
manual_bit_cfg.set_manual_activation_bit_width(
    [NodeNameScopeFilter('mul'),
     ...
     NodeNameScopeFilter('add_8'),
     NodeNameScopeFilter('add_9'),
     NodeNameScopeFilter('stack_1'),
     # NodeNameScopeFilter('add_10'),
     # NodeNameScopeFilter('exp'),
     # NodeNameScopeFilter('neg')
...
eval_results = coco_evaluate(model=model_pp.to(get_working_device()),
...
# Print float model mAP results 0.5043 / ir 0.5042
...
# Print quantized model mAP results 0.4835 / 0.4852 / 0.4838 / ir 0.4851 / 0.4840 / 0.4857

...
class DetectionModelPyTorch(nn.Module):
    ...
    def forward(self, x):
        ...
        for m in self.model:
            ...
            # print(len(y), x[0].mean())
        return x


def yolov8_pytorch(model_yaml: str) -> nn.Module:
    """
    ...
    model = DetectionModelPyTorch(cfg_dict, verbose=True)  # model
    return model

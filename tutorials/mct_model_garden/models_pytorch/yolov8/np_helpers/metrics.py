...
def compute_precision_recall(scores, labels, num_gt):
  ...
  if labels.dtype != np.float32 and labels.dtype != np.float64 and labels.dtype != bool:
...
def compute_average_precision(precision, recall):
  ...
  if (precision.dtype != np.float32 and precision.dtype != np.float64) or (recall.dtype != np.float32 and recall.dtype != np.float64):
...
def compute_cor_loc(num_gt_imgs_per_class,
  ...
  """
  # print('================================================================')
  # num_gt_imgs_per_class[num_gt_imgs_per_class==0]=100000000
